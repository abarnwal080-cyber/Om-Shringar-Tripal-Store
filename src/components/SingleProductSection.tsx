...
function MobileRelatedProductsCarousel({ products }: { products: Product[] }) {
  ...
  // Auto-scroll one by one every 5.5 seconds on mobile
  useEffect(() => {
  ...
  return (
    <div className="w-full bg-[#f8fafc] min-h-screen py-6 sm:py-10 text-slate-800 antialiased selection:bg-orange-100 selection:text-orange-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Back / Navigation Bar */}
        <div className="mb-4 flex items-center justify-between gap-3 bg-white px-4 py-3 rounded-2xl border border-slate-200/80 shadow-xs">
          <button
            onClick={onBack}
        ...
        {/* ========================================================================= */}
        {/* ATTENTIVE GOOGLE ADS BANNER (Win ₹100 Shopping Voucher on 5★ Review) */}
        {/* ========================================================================= */}
        <div className="mb-6">
          <GoogleReviewSection variant="google-ad" />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 p-5 sm:p-8 lg:p-10">
            ...
            <div className="lg:col-span-7 flex flex-col justify-between">
              <div>
                ...
                {/* Product Title */}
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black font-display text-slate-900 tracking-tight leading-tight mb-4">
                  {product.name}
                </h1>
        ...
        {/* ========================================================================= */}
        {/* GOOGLE REVIEW RATING COMPONENT (Verified Google Review) */}
        {/* ========================================================================= */}
        <GoogleReviewSection
          variant="banner"
          className="mt-14 rounded-3xl overflow-hidden border border-slate-200 shadow-sm"
        />
              ...
              return (
                ...
                >
                  <div 
                    ...
                    className="relative aspect-square bg-slate-50 overflow-hidden flex items-center justify-center p-3 border-b border-slate-100 cursor-pointer"
                  >
                    <img
                      src={p.images[0]}
                      alt={p.name}
